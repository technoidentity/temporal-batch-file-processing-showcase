...
public class JsonProcessorWorkflowImpl implements JsonProcessorWorkflow {
    ...
    @Override
    public StandardizedData processJson(FileMetadata fileMetadata, FileFormat format) {
        return activities.parseJsonFile(fileMetadata, format);
    }
}
